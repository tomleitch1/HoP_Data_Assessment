...
### DQ checks (23 total, `dashboard/core/rules/atamis_rules.py`)
...
- 23 checks across all four files (`dashboard/core/rules/atamis_rules.py`, scopes 30–33) — see the Atamis Domain section above for the full design (house derivation, join keys, the 6 cross-system checks with custom modal enrichment)
