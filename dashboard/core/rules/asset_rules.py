...
def get_asset_checks():
    ...
    checks = [
        ...
        ('DQ-AB-K02', 19, 'Asset Balances', 'Consistency', 'High',
         ...
         'Finds assets that have a disposal (SA) transaction but no capitalisation (CA) — an asset cannot be disposed of if it was never formally capitalised.',
        ...
        ('DQ-AB-K03', 19, 'Asset Balances', 'Consistency', 'High',
         ...
         'Identifies assets with depreciation transactions (ND, ED, FD) but no capitalisation (CA) — depreciation cannot be charged on an asset that was never capitalised.',
         'Review history.', 'asset_balances', None, 
